...
interface WhatsAppButtonProps {
  ...
  message?: string;
  /** Optional custom label for the tooltip. Defaults to "Chat on WhatsApp". */
  tooltipLabel?: string;
}

export const WhatsAppButton: React.FC<WhatsAppButtonProps> = ({
  phoneNumber = '923201611813',
  message = "Hi Dynova Cloud, I'd like to inquire about your services.",
  tooltipLabel = 'Chat on WhatsApp',
}) => {
  // Construct wa.me link. If phoneNumber is empty, wa.me/?text=... opens WhatsApp prompt.
  ...
  return (
    <div className="whatsapp-float-container">
      <span className="whatsapp-tooltip">{tooltipLabel}</span>
      <a
        href={whatsappUrl}
        target="_blank"
        rel="noopener noreferrer"
        className="whatsapp-float-btn"
        aria-label="Chat with Dynova Cloud on WhatsApp"
      >
